...
const Navbar = () => {
  return (
    <nav className="sticky top-0 z-50 bg-white container mx-auto flex items-center justify-between px-6 py-4 shadow-md">
      {/* Logo */}
      ...
      <ul className="flex items-center space-x-6 text-gray-700 font-medium">
        ...
        <li><Link to="/allcourses" className="hover:text-blue-500">Courses</Link></li>
